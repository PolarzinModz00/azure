...
" id="list" style="height: 208px; width:100%; text-align: center; resize:none;outline:none;" class="form-control" rows="8"></textarea>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="user-profile compact">
                                            <div class="up-head-w" style="background-image:url('https://c.tenor.com/ziEtUuTvVikAAAAC/money-counting.gif')">
                                                <div class="up-main-info">
                                                    <h2 class="up-header" style="text-align: center; font-family: 'Poiret One', cursive;">Dollar Checker<br>
   </h2>
